...
build-2136333201:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-2136333201-inproc

build-2136333201-inproc: ../flash_debug.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-2136333201
configPkg/compiler.opt: build-2136333201
configPkg/: build-2136333201

irgeneration-main.obj: ../irgeneration-main.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Compiler'
	"D:/CCS7.0/ccsv7/tools/compiler/ti-cgt-arm_16.9.0.LTS/bin/armcl" -mv7M3 --code_state=16 -me --include_path="C:/ti/tirtos_cc13xx_cc26xx_2_20_01_08/products/cc26xxware_2_24_02_17393" --include_path="C:/Users/csxwin/workspace_v7/tirtos_irgeneration_lp" --include_path="D:/CCS7.0/ccsv7/tools/compiler/ti-cgt-arm_16.9.0.LTS/include" --define=CC26XXWARE -g --gcc --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="irgeneration-main.d" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
