...
linker.cmd: package/cfg/flash_debug_pem3.xdl
	$(SED) 's"^\"\(package/cfg/flash_debug_pem3cfg.cmd\)\"$""\"C:/Users/csxwin/workspace_v7/tirtos_irgeneration_lp/.config/xconfig_flash_debug/\1\""' package/cfg/flash_debug_pem3.xdl > $@
