...
linker.cmd: package/cfg/app_ble_pem3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_pem3cfg.cmd\)\"$""\"C:/Users/csxwin/workspace_v7/simple_peripheral_cc2650em_app/.config/xconfig_app_ble/\1\""' package/cfg/app_ble_pem3.xdl > $@
