...
ti.targets.arm.elf.M3.rootDir ?= D:/CCS7.0/ccsv7/tools/compiler/ti-cgt-arm_16.9.0.LTS
...
flash_debug.xem3: package/cfg/flash_debug_pem3.oem3 
	...
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/flash_debug_pem3.oem3   package/cfg/flash_debug_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
